<script setup lang="ts">
    ...
    const props = defineProps(['forecastDate', 'day', 'location'])
    const forecastDate = computed(() => useDayHandler(new Date(props.forecastDate)))
</script>
            ...
            <div class="flex flex-col items-end justify-center">
                ...
                <div class="flex flex-col text-xs">
                    <div class="pr-1 flex flex-row-reverse items-center gap-2 text-primary-warm">
                        ...
                        <p class="font-bold">{{ day.maxtemp_c }}&#176C</p>
                    </div>
                    <div class="pr-1 flex flex-row-reverse items-center gap-2 text-primary-cool">
                        ...
                        <p class="font-bold">{{ day.mintemp_c }}&#176C</p>
                    </div>
                </div>
            </div>
        </div>
